...
type NavProp = NativeStackNavigationProp<MapStackParamList, 'MapAnimalDetail'>;
type RouteProps = RouteProp<MapStackParamList, 'MapAnimalDetail'>;

const MapAnimalDetailScreen = () => {
  ...
  return (
    <Background>
      <View style={[styles.container, { paddingTop: top }]}>
        <Text style={[styles.title, isSmallScreen && styles.titleSmall]}>Interactive map</Text>
...
export default MapAnimalDetailScreen;